...
class DictionaryCRUDTests extends \PHPUnit_Framework_TestCase{
    ...
    public function testRetrieveDefinition()
    {
        ...
        $this->assertEquals(
            "A razz and cool way of saying 'whats up'",
            $this->dictionary->retrieveDefinition("wetin dey")
        );
        $this->dictionary->retrieveDefinition("yolo");
    }
    ...
    public function testUpdateRecord()
    {
        ...
        $this->assertEquals(
            "A nasty yoruba comment",
            $this->dictionary->retrieveDefinition("kilonshele")
        );
        $this->dictionary->retrieveDefinition("yolo");
    }
